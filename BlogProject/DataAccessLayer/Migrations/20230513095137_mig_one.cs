    ...
    public partial class mig_one : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BlogAboutID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BlogAboutDetails = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BlogAboutImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BlogAboutMapLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BlogAboutStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogAbouts", x => x.BlogAboutID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsLetterss", x => x.MailID);
                });
